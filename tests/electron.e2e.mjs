...
try {
  ...
  await page.getByRole('dialog', { name: 'Modifier avec le rendu visible' }).waitFor({ state: 'visible' })
  ...
  await page.getByRole('dialog', { name: 'Ajuster depuis le rendu' }).waitFor({ state: 'visible' })
  await page.getByRole('button', { name: 'Fermer le guide' }).click()
